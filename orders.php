	...
	<div class="panel-body">
		...
		<?php if($_GET['o'] == 'add') {
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="supplierContact" name="supplierContact" placeholder="Contact Number" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    <label for="vat" class="col-sm-3 control-label">VAT 20%</label>
				    <div class="col-sm-9">
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    <label for="supplierContact" class="col-sm-3 control-label">Payment Type</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="supplierContact" class="col-sm-3 control-label">Payment Status</label>
				    <div class="col-sm-9">
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
  			...
  			$sql = "SELECT orders.order_id, orders.order_date, orders.supplier_name, orders.Supplier_contact, orders.sub_total, orders.vat, orders.total_amount, orders.discount, orders.grand_total, orders.paid, orders.due, orders.payment_type, orders.payment_status FROM orders
			  ...
			  <div class="form-group">
			    <label for="supplierName" class="col-sm-2 control-label">Supplier Name</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="supplierName" name="supplierName" placeholder="Supplier Name" autocomplete="off" value="<?php echo $data[2] ?>" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			    <label for="supplierContact" class="col-sm-2 control-label">Supplier Contact</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="supplierContact" name="supplierContact" placeholder="Contact Number" autocomplete="off" value="<?php echo $data[3] ?>" />
			    </div>
			  </div> <!--/form-group-->
