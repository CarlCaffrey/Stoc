...
<body>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-left">
        <li id="Stoc"><a href="index.php"><i class="glyphicon glyphicon-certificate"></i>  Stoc</a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li id="navBrand"><a href="brand.php"><i class="glyphicon glyphicon-transfer"></i>  Supplier</a></li>
