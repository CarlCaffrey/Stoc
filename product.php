    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	        ...
	        <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="MinQuantity" placeholder="3" name="MinQuantity" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	      	...
	      	<div class="div-result">
				  ...
				  <div class="tab-content">
			        ...
			        <div class="form-group">
			        	<label for="editMinQuantity" class="col-sm-3 control-label">Min Quantity: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="editMinQuantity" placeholder="3" name="editMinQuantity" autocomplete="off">
						    </div>
			        </div> <!-- /form-group-->
