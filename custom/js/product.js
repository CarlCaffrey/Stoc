...
$(document).ready(function() {
	...
	$("#addProductModalBtn").unbind('click').bind('click', function() {
		...
		$("#submitProductForm").unbind('submit').bind('submit', function() {
			...
			if(MinQuantity == "") {
				$("#MinQuantity").after('<p class="text-danger">Min Quantity field is required</p>');
				$('#MinQuantity').closest('.form-group').addClass('has-error');
			}	else {
				// remov error text field
				$("#MinQuantity").find('.text-danger').remove();
				// success out for form
				$("#MinQuantity").closest('.form-group').addClass('has-success');
			}	// /else
	...
	if(productId) {
		...
		$.ajax({
		  ...
		  // 		allowedFileExtensions: ["jpg", "png", "gif", "JPG", "PNG", "GIF"]
				...
				// quantity
				$("#editMinQuantity").val(response.MinQuantity);
				// rate
				...
				$("#editProductForm").unbind('submit').bind('submit', function() {
					...
					var MinQuantity = $("#editMinQuantity").val();
					...
					if(MinQuantity == "") {
						$("#editMinQuantity").after('<p class="text-danger">Min Quantity field is required</p>');
						$('#editMinQuantity').closest('.form-group').addClass('has-error');
					}	else {
						// remov error text field
						$("#editMinQuantity").find('.text-danger').remove();
						// success out for form
						$("#editMinQuantity").closest('.form-group').addClass('has-success');
					}	// /else
