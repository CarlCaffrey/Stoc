...
$(document).ready(function() {
	...
	if(divRequest == 'add')  {
		...
		$("#createOrderForm").unbind('submit').bind('submit', function() {
			...
			if(supplierName == "") {
				$("#supplierName").after('<p class="text-danger"> The Supplier Name field is required </p>');
			...
			if(supplierContact == "") {
				$("#supplierContact").after('<p class="text-danger"> The Contact field is required </p>');
	   	...
	   	for (var x = 0; x < quantity.length; x++) {
			...
			if(orderDate && supplierName && supplierContact && paid && discount && paymentType && paymentStatus) {
